  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto !px-4 !py-12">
        ...
        {/* Main Content */}
        <div className="max-w-4xl mx-auto space-y-8 text-lg leading-relaxed text-gray-800">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="mb-8">
              Therefore, our commitment extends beyond mere reaction. We endeavor to be a fountainhead of original research, insightful analysis, and articulate discourse that re-centers the Indic paradigm. Each article, essay, and critique published here will be guided by the twin lights of intellectual integrity and civilizational devotion. We will systematically deconstruct the prevailing distortions while simultaneously reconstructing a proud and accurate narrative of our past, a clear-eyed assessment of our present, and a visionary roadmap for our future. We invite every seeker of truth, every patriot, and every individual who feels the stirring of their ancestral memory to join us in this critical endeavor. Together, we shall endeavor to restore the voice of Dharma and rekindle the intellectual sovereignty of Bharat.
            </p>

            <div className="bg-gradient-to-r from-orange-100 to-red-100 rounded-lg p-8 my-12 border border-orange-300">
              <p className="text-xl font-semibold text-center mb-4 text-orange-800">
                The Call to Action
              </p>
              <p className="mb-4">
                Thus, the conch shell of Kurukshetra is sounded once more, not on a field of earthly combat, but on the intellectual and spiritual battlefield of our age. This platform is that sacred ground where the civilizational war for the soul of Bharat must be waged and won. We do not merely invite you to read; we call upon every true Bharatiya to take up their rightful place in this dharma-yuddha. In this struggle, you are both Arjuna, the warrior grappling with doubt and confronting a formidable adversary of distorted narratives, and BhagwanSri Krishna, the divine charioteer imparting the timeless wisdom of the Gita—the clarion call of truth and duty.
              </p>
              <p className="text-center font-bold text-lg text-orange-800">
                Let us, therefore, rise together. Shed the paralysis of confusion, arm yourselves with the weapon of discernment, and resolve to fight not for conquest, but for reclamation. Join us at Kurukshetra. Your civilization calls! Bharat Mata calls! Bharatiyata calls!
              </p>
            </div>
          </div>
        </div>
